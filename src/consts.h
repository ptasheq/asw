...
enum WorkerStates {SEARCHING_FOR_PAIR=0, SEARCHING_FOR_PUB, IN_PUB, WORKER_FINISHING, WORKER_FINISH};
enum AlcoholicStates {WAITING_FOR_PAIR=0, IN_PAIR, WAITING_FOR_SOBER_STATION, IN_SOBER_STATION, ALCOHOLIC_FINISHING, ALCOHOLIC_FINISH};
